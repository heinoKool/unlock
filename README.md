...
- Domain: Unter Settings → Pages optional eigene Domain (CNAME) hinterlegen.
- 404: Die Datei `404.html` leitet fehlende Routen automatisch zurück zur Startseite.
- Jekyll: `.nojekyll` stellt sicher, dass keine Jekyll-Verarbeitung erfolgt.

### Lokales Testen

Öffne einfach [index.html](index.html) im Browser oder starte einen kleinen lokalen Server:
